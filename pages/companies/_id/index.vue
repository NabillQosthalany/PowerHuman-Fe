    ...
    >
      ...
      <section class="pt-[50px]">
        ...
        <div class="grid gap-6 sm:grid-cols-2 md:grid-cols-3 lg:gap-11">
          <CardMolecules card-text="Employees" card-value="26" :link-to="createEmployeeLink"/>
...
export default {
  components: {CardMolecules},
  layout: 'dashboard',
  middleware: 'auth',
  data(){
    return{
      createEmployeeLink: { name: 'companies-id-employees-create' }
    }
  }
}
</script>
